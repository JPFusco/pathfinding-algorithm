import { NUMBER_OF_COLS, NUMBER_OF_ROWS, findNodeCoords } from "../home/script.js";
...
export function aStar(startNode, endNode, backGrid) {
    ...
    while (grid.length > 0) {
        ...
        for (let unvisitedNode of unvisitedNeighborNodes) {
            ...
            unvisitedNode.distance = (closestNode.distance - manhattanDistance(closestNode, endNode)) + 1 + manhattanDistance(unvisitedNode, endNode);
